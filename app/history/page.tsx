...
export default function HistoryPage() {
  ...
  const downloadPDF = () => {
    ...
    doc.text("Waktu: " + new Date().toLocaleTimeString('id-ID'), 20, 60)
    
    doc.setFontSize(14)
    doc.text("Data dari halaman Upload", 105, 80, { align: 'center' })
      ...
      <main className="flex-1 p-4">
        <Card className="max-w-sm mx-auto mt-8">
          <div className="p-6 text-center">
            <h2 className="text-lg font-semibold mb-4">Download Riwayat</h2>
            <p className="text-sm text-gray-500 mb-6">
              PDF berisi foto bintang oyoy
            </p>
